...
export const metadata: Metadata = {
  metadataBase: new URL("https://labelhost.sh"),
  title: {
    default: "labelhost | Named .localhost URLs for Development",
    template: "%s | labelhost",
  },
  ...
  openGraph: {
    type: "website",
    locale: "en_US",
    url: "https://labelhost.sh",
    siteName: "labelhost",
    title: "labelhost | Named .localhost URLs for Development",
    description: "Replace port numbers with stable, named .localhost URLs. For humans and agents.",
    images: [{ url: "/og", width: 1200, height: 630, alt: "labelhost" }],
  },
  twitter: {
    ...
    <header className="sticky top-0 z-50 bg-white/90 backdrop-blur-sm dark:bg-neutral-950/90">
      <div className="flex h-14 items-center justify-between px-4 gap-6">
        <div className="flex items-center gap-2">
          ...
          <Link href="/">
            <span className={`${GeistPixelSquare.className} text-lg`}>labelhost</span>
          </Link>
        </div>
        <nav className="flex items-center gap-4">
          <Search />
          <a
            href="https://github.com/WataruNishimura/labelhost"
            target="_blank"
          ...
          <a
            href="https://www.npmjs.com/package/labelhost"
            target="_blank"
            rel="noopener noreferrer"
