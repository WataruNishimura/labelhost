...
On WSL, labelhost updates both the Linux trust store and the Windows current-user Root store. Windows browsers can then verify labelhost HTTPS certificates served from WSL.
