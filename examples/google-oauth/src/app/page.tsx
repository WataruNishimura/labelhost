    ...
    <div className="flex min-h-svh items-center justify-center px-6 py-16">
      <div className="w-full max-w-md space-y-8">
        <div className="space-y-3">
          <h1 className="text-3xl font-semibold tracking-tight">Google OAuth + Labelhost</h1>
          <p className="text-base leading-relaxed text-muted-foreground">
            Google OAuth rejects{" "}
            <code className="rounded bg-muted px-1.5 py-0.5 font-mono text-xs text-foreground">
              .localhost
            </code>{" "}
            subdomains. Labelhost fixes this by serving your app on any valid TLD. Use a domain you
