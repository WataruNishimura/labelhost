...
describe("removeBlock", () => {
  ...
  it("removes the managed block and normalizes newlines", () => {
    ...
    expect(result).not.toContain("labelhost-start");
